...
namespace VAPP.Controllers
{
    ...
    public class SeasonsController : ControllerBase
    {
        ...
        public SeasonsController(VAPPContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Seasons
        [HttpGet]
        [Route("GetSeasonsByMovie/{id}")]
        public async Task<ActionResult<IEnumerable<Season>>> GetSeasonsByMovie(int id)
        {
            return await _context.Season.Where(x=>x.MovieId==id).ToListAsync();
        }
